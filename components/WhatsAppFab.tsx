  ...
  return (
    <a href={`https://wa.me/${wa}?text=Olá,%20gostaria%20de%20saber%20mais%20sobre%20os%20vistos`}
      ...
      <span
        ...
        aria-hidden
      />
      <span className="relative w-14 h-14 bg-green-500 hover:bg-green-600 text-white rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-all duration-200">
