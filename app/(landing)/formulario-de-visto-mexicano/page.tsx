...
import VistoMexicanoForm from './VistoMexicanoForm';

export const metadata: Metadata = {
  title: 'Formulário Visto Mexicano | Vow Vistos',
  description: 'Preencha o formulário para solicitar sua assessoria de visto mexicano com a Vow Vistos.',
  robots: { index: false },
};

export default function FormularioVistoMexicanoPage() {
  return (
      ...
      <div className="w-full max-w-2xl bg-white rounded-2xl shadow-lg p-8 md:p-12">
        <div className="mb-8">
          ...
          <p className="text-muted text-sm">
            Preencha os campos abaixo com atenção. Nossa equipe utilizará essas informações para preparar sua solicitação de visto mexicano.
          </p>
        </div>
