    ...
    return (
      <div className="space-y-6">
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-xl p-5 text-sm text-muted leading-relaxed max-h-48 overflow-y-auto">
          <p>Ao prosseguir, você confirma que leu e compreende as informações e condições gerais para solicitação e obtenção do visto americano. A Vow Vistos atuará como intermediária no processo, sendo responsável pelo preenchimento e envio do formulário DS-160 com os dados fornecidos pelo solicitante.</p>
        </div>
