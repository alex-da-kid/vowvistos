...
import VistoCanadenseForm from './VistoCanadenseForm';
      ...
      <div className="w-full max-w-2xl bg-white rounded-2xl shadow-lg p-8 md:p-12">
        <div className="mb-8">
          ...
          <p className="text-muted text-sm">
            Preencha os campos abaixo com atenção. Nossa equipe utilizará essas informações para preparar sua solicitação de visto canadense.
          </p>
        </div>
