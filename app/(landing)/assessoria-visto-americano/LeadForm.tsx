...
const situacaoOptions = [
  ...
  { value: 'Renovação do visto americano', label: 'Renovação do visto americano' },
...
export default function LeadForm({ compact = false }: { compact?: boolean }) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const text = encodeURIComponent(
      `Olá! Me chamo ${nome}. Meu WhatsApp: ${telefone}. Situação: ${situacao}. Gostaria de uma análise de perfil gratuita para o visto americano.`
    );
